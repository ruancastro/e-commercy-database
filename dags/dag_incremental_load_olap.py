...
def transform_dimensions_task(**kwargs):
    extracted_data = kwargs["ti"].xcom_pull(
        key="extracted_data", task_ids="extract_task"
    )
...
def load_dimensions_task(**kwargs):
    transformed_dimensions = kwargs["ti"].xcom_pull(
        key="transformed_dimensions", task_ids="transform_dimensions_task"
    )
...
def load_facts_task(**kwargs):
    transformed_facts = kwargs["ti"].xcom_pull(
        key="transformed_facts", task_ids="transform_facts_task"
    )
